/*
 * Copyright (C) 2019 DiepDT Bhatti <diep@1-vn.com>
 *
...
class Navigator @Inject constructor(
    ...
    /**
     * @param source String to indicate where this ONESMS+ screen was launched from. This should be
     * one of [main_menu, compose_schedule, settings_night, settings_theme]
     */
    fun showOnesmsPlusActivity(source: String) {
        analyticsManager.track("Viewed ONESMS+", Pair("source", source))
    ...
    fun showDeveloper() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/1-vn"))
        startActivity(intent)
    }

    fun showSourceCode() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/1-vn/onesms"))
        startActivity(intent)
    }

    fun showChangelog() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/1-vn/onesms/releases"))
        startActivity(intent)
    }

    fun showLicense() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/1-vn/onesms/blob/master/LICENSE"))
        startActivity(intent)
    }
    ...
    fun showDonation() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://bit.ly/ONESMSDonation"))
        startActivity(intent)
    }


    fun showRating() {
        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.onevn.ONESMS"))
        ...
        try {
            ...
            startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=com.onevn.ONESMS")))
        }
    }
    ...
    fun showSupport() {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, arrayOf("diep@1-vn.com"))
        intent.putExtra(Intent.EXTRA_SUBJECT, "ONESMS Support")
    ...
    fun showInvite() {
        ...
        Intent(Intent.ACTION_SEND)
                .setType("text/plain")
                .putExtra(Intent.EXTRA_TEXT, "http://1-vn.com/download-onesms")
