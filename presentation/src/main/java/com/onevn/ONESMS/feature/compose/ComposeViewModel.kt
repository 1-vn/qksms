...
import com.onevn.ONESMS.common.androidxcompat.scope
import com.onevn.ONESMS.common.base.QkViewModel
import com.onevn.ONESMS.common.util.BillingManager
import com.onevn.ONESMS.common.util.ClipboardUtils
import com.onevn.ONESMS.common.util.MessageDetailsFormatter
import com.onevn.ONESMS.common.util.extensions.makeToast
import com.onevn.ONESMS.compat.SubscriptionManagerCompat
import com.onevn.ONESMS.compat.TelephonyCompat
import com.onevn.ONESMS.extensions.asObservable
...
import com.onevn.ONESMS.filter.ContactFilter
import com.onevn.ONESMS.interactor.AddScheduledMessage
import com.onevn.ONESMS.interactor.CancelDelayedMessage
import com.onevn.ONESMS.interactor.ContactSync
import com.onevn.ONESMS.interactor.DeleteMessages
import com.onevn.ONESMS.interactor.MarkRead
import com.onevn.ONESMS.interactor.RetrySending
import com.onevn.ONESMS.interactor.SendMessage
...
import com.onevn.ONESMS.model.Attachments
...
import com.onevn.ONESMS.util.ActiveSubscriptionObservable
...
class ComposeViewModel @Inject constructor(
    ...
    override fun bindView(view: ComposeView) {
        ...
        view.scheduleIntent
                ...
                .filter { upgraded ->
                    upgraded.also { if (!upgraded) view.showOnesmsPlusSnackbar(R.string.compose_scheduled_plus) }
                }
                .autoDisposable(view.scope())
        ...
        // View ONESMS+
        view.viewOnesmsPlusIntent
                .autoDisposable(view.scope())
                .subscribe { navigator.showOnesmsPlusActivity("compose_schedule") }
